...
# system dependancies
sudo apt-get install -y network-manager net-tools openssh-server alsa-utils zathura rxvt compton feh suckless-tools ranger vim ffmpeg unzip python3 python3-pip
#ranger setup
